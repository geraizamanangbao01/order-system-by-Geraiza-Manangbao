...
<body>
    <?php
        include('header.php');                                   
    ?>
    <h2 class="styled-heading">AGENTS</h2><br />
    <?php
        require('config.php'); 
        $count = 0;
    ...
    <table table border="1" width="95%" class="center">
            ...
            <tr>
                ...
                <th colspan="2" aling="center">
                    <a href="#" data-toggle="modal" data-target="#addAgent" class="button-link">ADD RECORD</a>
                </th>
    ...
    ?>
            <tr>
                ...
                <td><a href="#" data-toggle="modal" data-target="#viewAgent<?php echo $count ?>" class="button-link">View</a></td>
                <td><a href="#" data-toggle="modal" data-target="#editAgent<?php echo $count ?>" class="button-link">Edit</a></td>
            </tr>
        <?php
            include 'modalViewAgent.php';
            include 'modalEditAgent.php';
            }
        } ?>
